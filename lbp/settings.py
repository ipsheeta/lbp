# Django settings for lovebalm project.
import os
...
# hack to turn off django-pipeline so unit tests work
if not DEBUG:
...
SECRET_KEY = 'eq-d%m-u^0@6*blxfy)v1(3bi*j%*j#x$n48(-(_2mlyg%g3so'
...
CKEDITOR_UPLOAD_PATH = os.path.join(PROJECT_ROOT, 'media', 'ckeditor')
...
FEINCMS_RICHTEXT_INIT_CONTEXT = {
    # TODO (julian) this works probably not the most elegant solution
    'TINYMCE_JS_URL' : STATIC_URL+'js/tinymce/jscripts/tiny_mce/tiny_mce.js',
    }
...
PENNYBLACK_TEXT_AND_IMAGE_CONTENT_POSITIONS = (('left','Left'),)
